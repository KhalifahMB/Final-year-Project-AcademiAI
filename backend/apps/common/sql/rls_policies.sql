...
-- after the tenant-scoped tables exist) and, for tables created by later
-- migrations, by the `post_migrate` receiver in apps/common/apps.py on every
-- `migrate`. The table list is DERIVED from the model registry in
