...
_"Without benchmarkable RAG quality, everything else is decoration."_
...
_"The AI should be a collaborator in every workflow, not a separate page."_
...
_"Students keep 3-5 tools. We need to be 2 of them."_
...
_"Lecturers need tools that save hours, not add clicks."_
...
_"Students are the end users. Everything serves them."_
...
- Flip dev DB to `academiai` role (no BYPASSRLS) — the long-standing recommendation.
...
_This document synthesises competitive research across Kortext IQ, Noodle Factory, ibl.ai, Google NotebookLM, ChatGPT, Anki, Knowt, RemNote, Perplexity, Otter.ai, QuillBot, Blackboard AI, and Canvas AI integrations. Last updated: September 2026._
