...
import { EVERYONE, STAFF, STUDENT_ONLY, TENANT_ADMIN_ONLY, roleHome } from '@/lib/access';
    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
          ...
          {/* App */}
          <Route path="/dashboard" element={<Guard roles={EVERYONE}><DashboardPage /></Guard>} />

          <Route path="/courses" element={<Guard roles={EVERYONE}><CoursesPage /></Guard>} />
          <Route path="/courses/:id" element={<Guard roles={EVERYONE}><CourseDetailPage /></Guard>} />
          <Route path="/my-courses" element={<Guard roles={STUDENT_ONLY}><MyCoursesPage /></Guard>} />
          <Route path="/my-programme" element={<Guard roles={STUDENT_ONLY}><MyProgrammePage /></Guard>} />
          <Route
            path="/assigned-courses"
            element={<Guard roles={STAFF}><AssignedCoursesPage /></Guard>}
          />

          <Route path="/resources" element={<Guard roles={EVERYONE}><ResourcesPage /></Guard>} />
          <Route path="/resources/upload" element={<Guard roles={EVERYONE}><UploadResourcePage /></Guard>} />

          <Route path="/chat" element={<Guard roles={EVERYONE}><ChatPage /></Guard>} />

          <Route path="/quizzes" element={<Guard roles={EVERYONE}><QuizzesPage /></Guard>} />
          <Route path="/quizzes/:id/take" element={<Guard roles={EVERYONE}><QuizTakePage /></Guard>} />
          <Route
            path="/admin/quizzes"
            element={<Guard roles={STAFF}><AdminQuizzesPage /></Guard>}
          />

          <Route
            path="/admin/dashboard"
            element={<Guard roles={TENANT_ADMIN_ONLY}><AdminDashboardPage /></Guard>}
          />
          <Route
            path="/admin/users"
            element={<Guard roles={TENANT_ADMIN_ONLY}><AdminUsersPage /></Guard>}
          />
          <Route
            path="/admin/audit"
            element={<Guard roles={TENANT_ADMIN_ONLY}><AdminAuditPage /></Guard>}
          />
          <Route
            path="/admin/tenant"
            element={<Guard roles={TENANT_ADMIN_ONLY}><TenantStructurePage /></Guard>}
          />
          <Route
            path="/admin/faculties/:id"
            element={<Guard roles={TENANT_ADMIN_ONLY}><FacultyDetailPage /></Guard>}
          />
          <Route
            path="/admin/departments/:id"
            element={<Guard roles={TENANT_ADMIN_ONLY}><DepartmentDetailPage /></Guard>}
          />
          <Route
            path="/admin/courses"
            element={<Guard roles={TENANT_ADMIN_ONLY}><AdminCoursesPage /></Guard>}
          />
          <Route
          ...
          <Route
            path="/platform"
            element={<Guard requireSuperuser><PlatformConsolePage /></Guard>}
          />
          <Route
            path="/platform/tenants"
            element={<Guard requireSuperuser><PlatformTenantsPage /></Guard>}
          />
          <Route
            path="/platform/tenants/:id"
            element={<Guard requireSuperuser><PlatformTenantDetailPage /></Guard>}
          />
          <Route
            path="/platform/requests"
            element={<Guard requireSuperuser><PlatformRequestsPage /></Guard>}
          />
          <Route
            path="/platform/analytics"
            element={<Guard requireSuperuser><PlatformAnalyticsPage /></Guard>}
          />
          <Route
            path="/platform/health"
            element={<Guard requireSuperuser><PlatformSystemHealthPage /></Guard>}
          />
          <Route
            path="/platform/audit"
            element={<Guard requireSuperuser><PlatformAuditLogPage /></Guard>}
          />
          <Route
            path="/platform/announcements"
            element={<Guard requireSuperuser><PlatformAnnouncementsPage /></Guard>}
          />
          ...
          <Route path="/forbidden" element={<Guard><ForbiddenPage /></Guard>} />
