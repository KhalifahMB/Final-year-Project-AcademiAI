    ...
    >
      <form onSubmit={submit} className="mx-auto grid max-w-4xl gap-5 lg:grid-cols-[1.4fr_1fr]">
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl border bg-card p-1 shadow-sm">
            ...
            >
              ...
              {file ? (
                ...
                <>
                  <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500/10 to-violet-500/10 text-primary">
          ...
          <div className="flex items-center justify-between">
            ...
            {upload.isPending ? (
              ...
              <Button type="submit" disabled={!file} size="sm" className="h-9 gap-2 px-5 text-xs font-medium shadow-sm">
                    ...
                    <li key={s.label} className="flex items-center gap-3">
                      <span
                        className={cn(
                          ...
                          doneStep && 'border-emerald-500/50 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400',
        ...
        <aside className="space-y-4 lg:sticky lg:top-4 lg:self-start">
          <div className="rounded-xl border bg-gradient-to-br from-indigo-50 to-violet-50 p-5 dark:from-indigo-950/30 dark:to-violet-950/30">
